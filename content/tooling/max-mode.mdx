...
description: "Max Mode expands Cursor's context window to the model's maximum — up to 1M tokens on supported models. It bills at API rates plus a 20% upcharge on individual plans. Here's when it earns that cost and when to leave it off."
