...
category: tooling
order: 4
interactiveTools: [prompt-lab, workflow-recipe]
---
...
> **Generate your own:** Use `/create-skill` or `/create-subagent` in Claude Code, or run the `skill-creator` skill to scaffold a skill or subagent tailored to your project.
