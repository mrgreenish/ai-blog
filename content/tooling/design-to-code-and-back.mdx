...
The loop runs both ways. Figma's [Claude Code to Figma](https://www.figma.com/blog/introducing-claude-code-to-figma/) (February 2026) lets you capture a live rendered UI — localhost, staging, or production — and import it into Figma as editable frames. See [Code to Canvas](/tooling/code-to-canvas) for the full reverse-loop workflow.
