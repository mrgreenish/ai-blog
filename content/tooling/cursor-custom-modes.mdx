...
Use `/create-skill` in Claude Code to scaffold a skill file, `/create-subagent` for a subagent definition, or run the `skill-creator` skill to generate a config tailored to your project conventions.
