...
It ships as a Cursor plugin (also works in Claude Code) and installs in one command — see the [README](https://github.com/mrgreenish/ai-council-plugin) for setup. Trigger it with `/ai-council` when you want the slower, more deliberate answer.
