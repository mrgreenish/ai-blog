...
- **[Best Practices for Using Claude Opus 4.7 with Claude Code](https://claude.com/blog/best-practices-for-using-claude-opus-4-7-with-claude-code)** — Anthropic
  Official guide to getting the most out of Opus 4.7 inside Claude Code — prompting patterns, when to reach for Opus over Sonnet or Haiku, and workflow tips tuned to the current model. Worth a read before retuning an existing harness for 4.7.
