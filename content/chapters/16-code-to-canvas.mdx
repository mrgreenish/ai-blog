...
The reverse flow — code to Figma — is equally powerful. Figma's [Claude Code to Figma](https://www.figma.com/blog/introducing-claude-code-to-figma/) capability lets you capture a live rendered UI and import it into Figma as editable frames.
