...
Max Mode answers a context question, not a general model-selection question. Use [Reasoning vs Fast AI Models for Coding](/chapters/reasoning-vs-fast) to decide how much reasoning the task needs before deciding whether its context also requires Max Mode.
