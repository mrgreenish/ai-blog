...
relatedSlugs: [spec-to-pr, spec-files, figma-mcp]
chapter: 7
...
**Figma MCP** gives Cursor direct access to design tokens, component variants, and layout data. The remote server is the recommended setup; the desktop server remains available for organization-specific local workflows. See [Figma MCP Workflows](/chapters/figma-mcp) for setup.
