...
Install Figma's recommended remote MCP server in Cursor with `/add-plugin figma`, then authenticate once. It connects directly to Figma's hosted endpoint, so you can pull design tokens, component properties, and layout data without keeping the desktop app open.
