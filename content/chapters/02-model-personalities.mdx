...
For the task-level decision—whether to pay for deeper reasoning or optimize for speed—start with [Reasoning vs Fast AI Models for Coding](/chapters/reasoning-vs-fast).
