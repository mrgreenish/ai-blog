...
(The [Spec → PR workflow](/chapters/spec-to-pr) covers writing a spec in chat before implementation — this chapter is about making that spec survive beyond the session.)
