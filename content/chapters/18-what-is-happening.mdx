...
<UpdateBlock>
  **Update, July 1:** Fable 5 is no longer blocked. The US government forced Anthropic to suspend it globally on June 12, but [lifted the export controls on June 30](https://www.anthropic.com/news/redeploying-fable-5). Anthropic says access returns globally today in Claude, Claude Code, Cowork, and its API; AWS, Google Cloud, and Microsoft Foundry will follow.
</UpdateBlock>
