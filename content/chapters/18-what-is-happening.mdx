...
Fable's plan access has settled into a less temporary shape than the initial July 7 launch allowance. On Max and Premium Team or seat-based Enterprise plans, it is included for up to **50% of weekly usage**; after that, usage credits take over. Pro and standard Team or seat-based Enterprise users need usage credits from the start. Mythos 5, the less-restricted version of the same underlying model, remains limited to approved Project Glasswing partners and the U.S. government.
