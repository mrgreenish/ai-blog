...
When work starts in an issue tracker, first turn the request into an executable contract. The [Jira-to-Cursor workflow](/chapters/jira-to-cursor) shows how scope, evidence, acceptance criteria, and stop conditions become agent context before this spec-to-PR loop begins.
