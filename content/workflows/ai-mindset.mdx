...
For complex tasks, go further: **"What assumptions are you making? List them before you begin."** Surfacing assumptions is even more useful than asking questions — it shows you what the model filled in on its own, and gives you a chance to correct it before those assumptions are baked into the output.
