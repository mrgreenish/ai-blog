...
One way to make this explicit: before asking for the plan, add **"If anything in the spec is unclear or leaves room for multiple interpretations, ask me before planning."** This turns the plan step into a two-pass process — clarify first, then plan — and consistently produces tighter output.
