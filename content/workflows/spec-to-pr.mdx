...
story: "You skip the plan step and go straight to code. The model produces something that works for the happy path — and misses the three constraints you had in mind. Now you're correcting code instead of reviewing a plan."
category: workflows
order: 2
