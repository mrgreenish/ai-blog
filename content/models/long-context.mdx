...
The expansion to large context windows (Claude commonly at 200k and Gemini models up to 1M tokens) has changed what's practical for developer workflows. Some tasks that required RAG pipelines a year ago can now be done by sending much more source context directly. But "can" doesn't mean "should" — there are real tradeoffs.
