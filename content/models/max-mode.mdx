...
By default, Cursor operates with a 200K token context window — roughly 15,000 lines of code. That covers most single-feature work. Max Mode extends that to 1M tokens (about 75,000 lines) for models that support it, like Gemini 2.5 Pro and GPT-4.1.
