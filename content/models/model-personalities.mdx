...
**Fast iteration loop.** Because it's embedded in the editor, the round-trip from prompt to applied diff is fast. You see the change inline, accept or reject hunks, and move on. This tight feedback loop makes it well-suited for the kind of rapid, incremental work that makes up most of a coding day.
...
**For Cursor Composer-1:** point it at the specific thing you want changed. It works best with a clear target — a file, a function, a prop. The more precise your instruction, the cleaner the output.
