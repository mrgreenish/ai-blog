...
## Cursor Composer 2: the agentic & fast one

<PersonalFavorite />

<ModelLabels provider="Cursor" tier="Agentic" bestFor="End-to-end tasks" />

Composer 2 doesn't just edit files — it acts. Terminal commands, reading output, making more edits, looping until the task is done. Closest thing to an AI developer that can execute end-to-end.
