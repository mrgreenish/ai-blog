  ...
  return fs
    ...
    .map((file) => {
      ...
      return {
        ...
        frontmatter: data as NewsEntryFrontmatter,
        content,
      };
    })
    .sort((a, b) => {
      const dateOrder = b.frontmatter.publishedAt.localeCompare(
...
export const getNewsEntry = cache(function getNewsEntry(slug: string): NewsEntry | null {
